strings = {
    ...
    "message_change_which_model": {
        "zh": "请你输入希望切换的模型",
        "en": "Please enter the model you want to switch to",
        "zh-hk": "請輸入你想用的模型",
        "ru": "Пожалуйста, введите модель, на которую вы хотите переключиться",
    }
    "message_change_success":
    {
        'en': "Model switched to {model}.",
        'zh': "模型已切换至 {model}。",
        'ru': "Модель переключена на {model}."
    }
}
